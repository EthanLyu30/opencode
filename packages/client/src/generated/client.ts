import type {
  ...
  ResponsesDeleteOutput,
  ResponsesCancelInput,
  ResponsesCancelOutput,
  ResponsesInputItemsInput,
  ResponsesInputItemsOutput,
  ResponsesEventsInput,
  ResponsesEventsOutput,
  ConversationsCreateInput,
  ConversationsCreateOutput,
  ConversationsGetInput,
  ConversationsGetOutput,
  ConversationsDeleteInput,
  ConversationsDeleteOutput,
  ConversationsAppendItemInput,
  ConversationsAppendItemOutput,
  ConversationsItemsInput,
  ConversationsItemsOutput,
  MessagesListInput,
  MessagesListOutput,
  ModelsListInput,
  ModelsListOutput,
...
export function make(options: ClientOptions) {
  ...
  return {
    ...
    responses: {
        ...
        requestMixed<ResponsesCreateOutput>(
          {
            ...
            body: {
              ...
              promptCacheOptions: input["promptCacheOptions"],
      ...
      get: (input: ResponsesGetInput, requestOptions?: RequestOptions) =>
        request<ResponsesGetOutput>(
          {
            method: "GET",
            path: `/v1/responses/${encodeURIComponent(input.responseID)}`,
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
          },
      ...
      delete: (input: ResponsesDeleteInput, requestOptions?: RequestOptions) =>
        request<ResponsesDeleteOutput>(
          {
            method: "DELETE",
            path: `/v1/responses/${encodeURIComponent(input.responseID)}`,
            successStatus: 204,
      ...
      cancel: (input: ResponsesCancelInput, requestOptions?: RequestOptions) =>
        request<ResponsesCancelOutput>(
          {
            method: "POST",
            path: `/v1/responses/${encodeURIComponent(input.responseID)}/cancel`,
            successStatus: 200,
            declaredStatuses: [404, 409, 401, 400],
            empty: false,
          },
      ...
      inputItems: (input: ResponsesInputItemsInput, requestOptions?: RequestOptions) =>
        request<{ readonly data: ResponsesInputItemsOutput }>(
          {
            method: "GET",
            path: `/v1/responses/${encodeURIComponent(input.responseID)}/input_items`,
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
          },
      ...
      events: (input: ResponsesEventsInput, requestOptions?: RequestOptions): AsyncIterable<ResponsesEventsOutput> =>
        sse<ResponsesEventsOutput>(
          {
            method: "GET",
            path: `/v1/responses/${encodeURIComponent(input.responseID)}/event`,
            query: { after: input["after"] },
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
    ...
    conversations: {
      create: (input: ConversationsCreateInput, requestOptions?: RequestOptions) =>
        request<ConversationsCreateOutput>(
          {
            method: "POST",
            path: `/v1/conversations`,
            body: { id: input["id"], metadata: input["metadata"] },
            successStatus: 200,
            declaredStatuses: [400, 409, 401],
            empty: false,
          },
      ...
      get: (input: ConversationsGetInput, requestOptions?: RequestOptions) =>
        request<ConversationsGetOutput>(
          {
            method: "GET",
            path: `/v1/conversations/${encodeURIComponent(input.conversationID)}`,
            successStatus: 200,
            declaredStatuses: [404, 401, 400],
            empty: false,
          },
      ...
      delete: (input: ConversationsDeleteInput, requestOptions?: RequestOptions) =>
        request<ConversationsDeleteOutput>(
          {
            method: "DELETE",
            path: `/v1/conversations/${encodeURIComponent(input.conversationID)}`,
            successStatus: 204,
      ...
      appendItem: (input: ConversationsAppendItemInput, requestOptions?: RequestOptions) =>
        request<ConversationsAppendItemOutput>(
          {
            method: "POST",
            path: `/v1/conversations/${encodeURIComponent(input.conversationID)}/items`,
            body: { responseID: input["responseID"], payload: input["payload"] },
            successStatus: 200,
      ...
      items: (input: ConversationsItemsInput, requestOptions?: RequestOptions) =>
        request<{ readonly data: ConversationsItemsOutput }>(
          {
            method: "GET",
            path: `/v1/conversations/${encodeURIComponent(input.conversationID)}/items`,
            successStatus: 200,
